...
local hlgroups = {
  ...
  ["@markup.heading.2.markdown"] = { fg = c_macroPink },
  ["@markup.heading.3.markdown"] = { fg = c_waveAqua0 },
  ["@markup.heading.4.markdown"] = { fg = c_autumnYellow },
  ["@markup.heading.5.markdown"] = { fg = c_macroOrange0 },
  ["@markup.heading.6.markdown"] = { fg = c_macroGreen1 },
  ...
  MiniDiffSignAdd = { fg = c_macroGreen1 },
  MiniDiffSignChange = { fg = c_carpYellow },
  MiniDiffSignDelete = { fg = c_macroRed },
  ...
  MiniPickBorder = { link = "TelescopeBorder" },
  MiniPickBorderBusy = { link = "TelescopeMatching" },
  MiniPickBorderText = { fg = c_macroRed },
  MiniPickCursor = { fg = c_macroRed },
  MiniPickIconDirectory = { link = "Directory" },
  MiniPickIconFile = { link = "Directory" },
  MiniPickHeader = { link = "TelescopeTitle" },
  MiniPickMatchCurrent = { link = "Visual" },
  MiniPickMatchMarked = { link = "TelescopeMatching" },
  MiniPickMatchRanges = { link = "TelescopeMatching" },
  MiniPickNormal = { link = "TelescopeNormal" },
  MiniPickPrompt = { link = "TelescopePromptNormal" },
