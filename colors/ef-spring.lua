...
hi("DiagnosticError", { fg = colors.red, bg = colors.red_bg })
hi("DiagnosticHint", { fg = colors.blue, bg = colors.blue_bg })
hi("DiagnosticInfo", { fg = colors.green, bg = colors.green_bg })
hi("DiagnosticWarn", { fg = colors.yellow, bg = colors.yellow_bg })
