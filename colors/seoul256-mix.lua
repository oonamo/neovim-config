...
vim.g.colors_name = "seoul256-mix"

-- Highlight groups
local hi = vim.api.nvim_set_hl

hi(0, "ALEErrorSign", { bg = "#3f3f3f", ctermbg = 238, ctermfg = 161, fg = "#e12672" })
hi(0, "ALEWarningSign", { bg = "#3f3f3f", ctermbg = 238, ctermfg = 174, fg = "#e09b99" })
hi(0, "Boolean", { ctermfg = 247, fg = "#999abd" })
hi(0, "Character", { ctermfg = 174, fg = "#e09b99" })
hi(0, "CocFloating", { bg = "#252525", ctermbg = 235, ctermfg = 253, fg = "#d9d9d9" })
hi(0, "ColorColumn", { bg = "#333233", ctermbg = 236 })
hi(0, "Comment", { ctermfg = 65, fg = "#719872" })
hi(0, "Conceal", { bg = "#333233", ctermbg = 236, ctermfg = 255, fg = "#e9e9e9" })
hi(0, "Conditional", { ctermfg = 146, fg = "#98bede" })
hi(0, "Constant", { ctermfg = 73, fg = "#6fbcbd" })
hi(0, "Cursor", { bg = "#d9d9d9", ctermbg = 253, ctermfg = 238, fg = "#3f3f3f" })
hi(0, "CursorColumn", { bg = "#333233", ctermbg = 236 })
hi(0, "CursorLine", { bg = "#333233", ctermbg = 236 })
hi(0, "CursorLineNr", { bg = "#333233", bold = true, ctermbg = 236, ctermfg = 167, fg = "#be7572" })
hi(0, "Define", { ctermfg = 173, fg = "#e19972" })
hi(0, "Delimiter", { ctermfg = 137, fg = "#be9873" })
hi(0, "DiffAdd", { bg = "#006f00", ctermbg = 22 })
hi(0, "DiffChange", { bg = "#616161", ctermbg = 241 })
...
hi(0, "ExtraWhitespace", { bg = "#333233", ctermbg = 236 })
hi(0, "Float", { ctermfg = 222, fg = "#ffde99" })
hi(0, "FoldColumn", { bg = "#4b4b4b", ctermbg = 239, ctermfg = 144, fg = "#bdbc98" })
hi(0, "Folded", { bg = "#4b4b4b", ctermbg = 239, ctermfg = 246, fg = "#999872" })
hi(0, "Function", { ctermfg = 187, fg = "#dfdebd" })
hi(0, "GitGutterAdd", { bg = "#4b4b4b", ctermbg = 239, ctermfg = 108, fg = "#98bc99" })
hi(0, "GitGutterChange", { bg = "#4b4b4b", ctermbg = 239, ctermfg = 104, fg = "#719cdf" })
hi(0, "GitGutterChangeDelete", { bg = "#4b4b4b", ctermbg = 239, ctermfg = 175, fg = "#e17899" })
hi(0, "GitGutterDelete", { bg = "#4b4b4b", ctermbg = 239, ctermfg = 161, fg = "#e12672" })
hi(0, "Identifier", { ctermfg = 217, fg = "#ffbfbd" })
hi(0, "Ignore", { bg = "#3f3f3f", ctermbg = 238, ctermfg = 241, fg = "#616161" })
hi(0, "IncSearch", { bg = "#4b4b4b", ctermbg = 239, ctermfg = 220, fg = "#ffdd00" })
hi(0, "Include", { ctermfg = 173, fg = "#e19972" })
hi(0, "IndentGuidesEven", { bg = "#4b4b4b", ctermbg = 239 })
hi(0, "IndentGuidesOdd", { bg = "#333233", ctermbg = 236 })
hi(0, "Keyword", { ctermfg = 175, fg = "#e17899" })
hi(0, "LazyBold", { bold = true })
hi(0, "LazyItalic", { italic = true })
hi(0, "LineNr", { bg = "#4b4b4b", ctermbg = 239, ctermfg = 246, fg = "#999872" })
hi(0, "Macro", { ctermfg = 173, fg = "#e19972" })
hi(0, "MatchParen", { bg = "#616161", bold = true, ctermbg = 241 })
...
hi(0, "Normal", { bg = "#3f3f3f", ctermbg = 238, ctermfg = 253, fg = "#d9d9d9" })
hi(0, "NormalFloat", { bg = "#333233", ctermbg = 236 })
hi(0, "Number", { ctermfg = 222, fg = "#ffde99" })
hi(0, "Operator", { ctermfg = 186, fg = "#dedd99" })
hi(0, "Pmenu", { bg = "#4b4b4b", ctermbg = 239, ctermfg = 253, fg = "#d9d9d9" })
...
hi(0, "SignColumn", { bg = "#3f3f3f", ctermbg = 238, ctermfg = 173, fg = "#e19972" })
hi(0, "SignifySignAdd", { bg = "#4b4b4b", ctermbg = 239, ctermfg = 108, fg = "#98bc99" })
hi(0, "SignifySignChange", { bg = "#4b4b4b", ctermbg = 239, ctermfg = 104, fg = "#719cdf" })
hi(0, "SignifySignDelete", { bg = "#4b4b4b", ctermbg = 239, ctermfg = 161, fg = "#e12672" })
...
hi(0, "ZenBg", { bg = "#3f3f3f", ctermbg = 238, ctermfg = 238, fg = "#3f3f3f" })
hi(0, "diffAdded", { ctermfg = 108, fg = "#98bc99" })
hi(0, "diffLine", { link = "Constant" })
hi(0, "diffRemoved", { ctermfg = 174, fg = "#e09b99" })
hi(0, "lCursor", { bg = "#d9d9d9", ctermbg = 253, ctermfg = 238, fg = "#3f3f3f" })
