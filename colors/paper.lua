...
hi("@markup.heading.gitcommit",      { fg =  c.color17, bold = true                                       })
hi("@keyword.gitcommit",             { fg =  c.color14                                                    })
hi("@string.special.path.gitcommit", { fg =  c.color09                                                    })

hi("MiniPickMatchCurrent",           { bg = vim.o.bg == "light" and c.error_bg or c.cursorline                                                    })
hi("MiniPickNormal", { link = "Pmenu"})

hi("MiniPickBorder", { fg = c.vertsplit_fg})
hi("MiniPickBorderBusy", { link = "MiniPickBorder"})
-- hi("MiniPickBorderText", { fg = c.color05})
-- hi("MiniPickCursor", {})
-- hi("MiniPickIconDirectory", {})
-- hi("MiniPickIconFile", {})
hi("MiniPickHeader", { fg = c.color05})
-- hi("MiniPickMatchCurrent", {})
-- hi("MiniPickMatchMarked", {})
hi("MiniPickMatchRanges", { fg = c.color14, bold = true})
hi("MiniPickNormal", { fg = c.popupmenu_fg, bg = c.popupmenu_b})
-- hi("MiniPickPreviewLine", {})
-- hi("MiniPickPreviewRegion", {})
hi("MiniPickPrompt", { fg = c.popupmenu_fg})


hi("MiniIconsAzure", { fg = c.color16})
hi("MiniIconsBlue", { fg = c.color14})
hi("MiniIconsCyan", { fg = c.color04})
hi("MiniIconsGreen", { fg = c.diffadd_fg})
hi("MiniIconsGrey", { fg = c.color05})
hi("MiniIconsOrange", { fg = c.color13})
hi("MiniIconsPurple", { fg = c.color11})
hi("MiniIconsRed", { fg = c.error_fg})
hi("MiniIconsYellow", { fg = "#ffff00"})

hi("StatuslineNormal", { fg = c.color07, bg = c.color00, })
