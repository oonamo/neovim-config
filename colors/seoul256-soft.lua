...
vim.g.colors_name = "seoul256-soft"
...
hi(0, "FoldColumn", { bg = "#252525", ctermbg = 235, ctermfg = 144, fg = "#bdbc98" })
hi(0, "Folded", { bg = "#252525", ctermbg = 235, ctermfg = 246, fg = "#999872" })
hi(0, "Function", { ctermfg = 187, fg = "#dfdebd" })
hi(0, "GitGutterAdd", { bg = "#252525", ctermbg = 235, ctermfg = 108, fg = "#98bc99" })
hi(0, "GitGutterChange", { bg = "#252525", ctermbg = 235, ctermfg = 104, fg = "#719cdf" })
hi(0, "GitGutterChangeDelete", { bg = "#252525", ctermbg = 235, ctermfg = 175, fg = "#e17899" })
hi(0, "GitGutterDelete", { bg = "#252525", ctermbg = 235, ctermfg = 161, fg = "#e12672" })
hi(0, "Identifier", { ctermfg = 217, fg = "#ffbfbd" })
hi(0, "Ignore", { bg = "#171717", ctermbg = 233, ctermfg = 238, fg = "#3f3f3f" })
hi(0, "IncSearch", { bg = "#252525", ctermbg = 235, ctermfg = 220, fg = "#ffdd00" })
hi(0, "Include", { ctermfg = 173, fg = "#e19972" })
hi(0, "IndentGuidesEven", { bg = "#252525", ctermbg = 235 })
...
hi(0, "LineNr", { bg = "#252525", ctermbg = 235, ctermfg = 246, fg = "#999872" })
hi(0, "Macro", { ctermfg = 173, fg = "#e19972" })
hi(0, "MatchParen", { bg = "#3f3f3f", bold = true, ctermbg = 238 })
...
hi(0, "Normal", { bg = "#171717", ctermbg = 233, ctermfg = 253, fg = "#d9d9d9" })
hi(0, "NormalFloat", { bg = "#060606", ctermbg = 232 })
hi(0, "Number", { ctermfg = 222, fg = "#ffde99" })
hi(0, "Operator", { ctermfg = 186, fg = "#dedd99" })
hi(0, "Pmenu", { bg = "#252525", ctermbg = 235, ctermfg = 253, fg = "#d9d9d9" })
...
hi(0, "SignifySignAdd", { bg = "#252525", ctermbg = 235, ctermfg = 108, fg = "#98bc99" })
hi(0, "SignifySignChange", { bg = "#252525", ctermbg = 235, ctermfg = 104, fg = "#719cdf" })
hi(0, "SignifySignDelete", { bg = "#252525", ctermbg = 235, ctermfg = 161, fg = "#e12672" })
...
hi(0, "StatusLineNC", { bg = "#dfdebd", ctermbg = 187, ctermfg = 236, fg = "#333233" })
hi(0, "StatusLineTerm", { bg = "#dfdebd", bold = true, ctermbg = 187, ctermfg = 244, fg = "#9a7372", reverse = true })
hi(0, "StatusLineTermNC", { bg = "#dfdebd", bold = true, ctermbg = 187, ctermfg = 236, fg = "#333233", reverse = true })
hi(0, "String", { ctermfg = 249, fg = "#98bcbd" })
hi(0, "StringDelimiter", { ctermfg = 137, fg = "#be9873" })
hi(0, "Structure", { ctermfg = 116, fg = "#97dddf" })
hi(0, "TabLine", { bg = "#4b4b4b", ctermbg = 239, ctermfg = 245 })
hi(0, "TabLineFill", { ctermfg = 236, fg = "#333233" })
...
hi(0, "ZenBg", { bg = "#171717", ctermbg = 233, ctermfg = 233, fg = "#171717" })
hi(0, "diffAdded", { ctermfg = 108, fg = "#98bc99" })
hi(0, "diffLine", { link = "Constant" })
hi(0, "diffRemoved", { ctermfg = 174, fg = "#e09b99" })
hi(0, "lCursor", { bg = "#d9d9d9", ctermbg = 253, ctermfg = 233, fg = "#171717" })
