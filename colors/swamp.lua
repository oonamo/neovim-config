...
hi("DiffDelete", { fg = palette.base08, bg = "#d1bb92" })
...
hi("MiniIconsAzure", { fg = palette.base0F })
hi("MiniIconsBlue", { fg = palette.base0F })
hi("MiniIconsCyan", { fg = palette.base0F })
hi("MiniIconsGreen", { fg = palette.base0B })
hi("MiniIconsGrey", { fg = palette.base02 })
hi("MiniIconsOrange", { fg = palette.base0C })
hi("MiniIconsPurple", { fg = palette.base0E })
hi("MiniIconsRed", { fg = palette.base0A })
hi("MiniIconsYellow", { fg = palette.base08 })
