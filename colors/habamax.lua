local colors = {
	...
	NvimTreeEndOfBuffer = { link = "EndOfBuffer" }, -- NvimTreeEndOfBuffer xxx links to EndOfBuffer
	TermCursor = { reverse = true }, -- TermCursor     xxx cterm=reverse gui=reverse
	GitSignsAddInline = { link = "TermCursor" }, -- GitSignsAddInline xxx links to TermCursor
	GitSignsDeleteInline = { link = "TermCursor" }, -- GitSignsDeleteInline xxx links to TermCursor
	GitSignsChangeInline = { link = "TermCursor" }, -- GitSignsChangeInline xxx links to TermCursor
	NonText = { fg = "#585858" }, -- NonText        xxx ctermfg=240 guifg=#585858
	Whitespace = { link = "NonText" }, -- Whitespace     xxx links to NonText
	TelescopePreviewHyphen = { link = "NonText" }, -- TelescopePreviewHyphen xxx links to NonText
	TelescopePromptCounter = { link = "NonText" }, -- TelescopePromptCounter xxx links to NonText
	TelescopeResultsDiffUntracked = { link = "NonText" }, -- TelescopeResultsDiffUntracked xxx links to NonText
	GitSignsCurrentLineBlame = { link = "NonText" }, -- GitSignsCurrentLineBlame xxx links to NonText
	Directory = { fg = "#87afaf", bold = true }, -- Directory      xxx cterm=bold ctermfg=109 gui=bold guifg=#87afaf
	NvimTreeOpenedFolderName = { link = "Directory" }, -- NvimTreeOpenedFolderName xxx links to Directory
	NvimTreeFolderName = { link = "Directory" }, -- NvimTreeFolderName xxx links to Directory
	NvimTreeEmptyFolderName = { link = "Directory" }, -- NvimTreeEmptyFolderName xxx links to Directory
	TelescopePreviewDirectory = { link = "Directory" }, -- TelescopePreviewDirectory xxx links to Directory
	TelescopePreviewDate = { link = "Directory" }, -- TelescopePreviewDate xxx links to Directory
	ErrorMsg = { bg = "#1c1c1c", reverse = true, fg = "#d75f5f" }, -- ErrorMsg       xxx cterm=reverse ctermfg=167 ctermbg=234 gui=reverse guifg=#d75f5f guibg=#1c1c1c
	NvimInvalidSpacing = { link = "ErrorMsg" }, -- NvimInvalidSpacing xxx links to ErrorMsg
	LazyTaskError = { link = "ErrorMsg" }, -- LazyTaskError  xxx links to ErrorMsg
	IncSearch = { fg = "#1c1c1c", bg = "#ffaf5f" }, -- IncSearch      xxx ctermfg=234 ctermbg=215 guifg=#1c1c1c guibg=#ffaf5f
	LazyH1 = { link = "IncSearch" }, -- LazyH1         xxx links to IncSearch
	Search = { fg = "#1c1c1c", bg = "#87af87" }, -- Search         xxx ctermfg=234 ctermbg=108 guifg=#1c1c1c guibg=#87af87
	Substitute = { link = "Search" }, -- Substitute     xxx links to Search
	TelescopePreviewMatch = { link = "Search" }, -- TelescopePreviewMatch xxx links to Search
	...
	LazyProgressTodo = { link = "LineNr" }, -- LazyProgressTodo xxx links to LineNr
	TelescopeResultsLineNr = { link = "LineNr" }, -- TelescopeResultsLineNr xxx links to LineNr
	NvimTreeLineNr = { link = "LineNr" }, -- NvimTreeLineNr xxx links to LineNr
	...
	CursorLineNr = { fg = "#ffaf5f", bold = true }, -- CursorLineNr   xxx cterm=bold ctermfg=215 gui=bold guifg=#ffaf5f
	NvimTreeCursorLineNr = { link = "CursorLineNr" }, -- NvimTreeCursorLineNr xxx links to CursorLineNr
	...
	MsgSeparator = { link = "StatusLine" }, -- MsgSeparator   xxx links to StatusLine
	StatusLineTerm = { link = "StatusLine" }, -- StatusLineTerm xxx links to StatusLine
	NvimTreeStatusLine = { link = "StatusLine" }, -- NvimTreeStatusLine xxx links to StatusLine
	StatusLineNC = { fg = "#1c1c1c", bg = "#767676" }, -- StatusLineNC   xxx ctermfg=234 ctermbg=243 guifg=#1c1c1c guibg=#767676
	StatusLineTermNC = { link = "StatusLineNC" }, -- StatusLineTermNC xxx links to StatusLineNC
	NvimTreeStatusLineNC = { link = "StatusLineNC" }, -- NvimTreeStatusLineNC xxx links to StatusLineNC
	VertSplit = { fg = "#767676", bg = "#767676" }, -- VertSplit      xxx ctermfg=243 ctermbg=243 guifg=#767676 guibg=#767676
	WinSeparator = { link = "VertSplit" }, -- WinSeparator   xxx links to VertSplit
	Title = { fg = "#d7d787", bold = true }, -- Title          xxx cterm=bold ctermfg=186 gui=bold guifg=#d7d787
	FloatTitle = { link = "Title" }, -- FloatTitle     xxx links to Title
	LazyCommitType = { link = "Title" }, -- LazyCommitType xxx links to Title
	NullLsInfoSources = { link = "Title" }, -- NullLsInfoSources xxx links to Title
	LspInfoTitle = { link = "Title" }, -- LspInfoTitle   xxx links to Title
	gitCommitSummary = { link = "Title" }, -- gitCommitSummary xxx links to Title
	Visual = { fg = "#1c1c1c", bg = "#87afaf" }, -- Visual         xxx ctermfg=234 ctermbg=109 guifg=#1c1c1c guibg=#87afaf
	LazyButtonActive = { link = "Visual" }, -- LazyButtonActive xxx links to Visual
	TelescopePreviewLine = { link = "Visual" }, -- TelescopePreviewLine xxx links to Visual
	...
	CursorLineFold = { link = "FoldColumn" }, -- CursorLineFold xxx links to FoldColumn
	DiffAdd = { fg = "#000000", bg = "#87af87" }, -- DiffAdd        xxx ctermfg=16 ctermbg=108 guifg=#000000 guibg=#87af87
	TelescopeResultsDiffAdd = { link = "DiffAdd" }, -- TelescopeResultsDiffAdd xxx links to DiffAdd
	GitSignsAddLn = { link = "DiffAdd" }, -- GitSignsAddLn  xxx links to DiffAdd
	GitSignsAddPreview = { link = "DiffAdd" }, -- GitSignsAddPreview xxx links to DiffAdd
	DiffChange = { fg = "#000000", bg = "#afafaf" }, -- DiffChange     xxx ctermfg=16 ctermbg=145 guifg=#000000 guibg=#afafaf
	GitSignsChange = { link = "DiffChange" }, -- GitSignsChange xxx links to DiffChange
	TelescopeResultsDiffChange = { link = "DiffChange" }, -- TelescopeResultsDiffChange xxx links to DiffChange
	GitSignsChangeLn = { link = "DiffChange" }, -- GitSignsChangeLn xxx links to DiffChange
	DiffDelete = { fg = "#af875f" }, -- DiffDelete     xxx ctermfg=137 guifg=#af875f
	TelescopeResultsDiffDelete = { link = "DiffDelete" }, -- TelescopeResultsDiffDelete xxx links to DiffDelete
	GitSignsDeletePreview = { link = "DiffDelete" }, -- GitSignsDeletePreview xxx links to DiffDelete
	GitSignsDeleteVirtLn = { link = "DiffDelete" }, -- GitSignsDeleteVirtLn xxx links to DiffDelete
	...
	LazyProp = { link = "Conceal" }, -- LazyProp       xxx links to Conceal
	LazyDimmed = { link = "Conceal" }, -- LazyDimmed     xxx links to Conceal
	SpellBad = { sp = "#d75f5f", undercurl = true }, -- SpellBad       xxx cterm=underline ctermfg=167 gui=undercurl guisp=#d75f5f
	SpellCap = { sp = "#5f87af", undercurl = true }, -- SpellCap       xxx cterm=underline ctermfg=67 gui=undercurl guisp=#5f87af
	SpellRare = { sp = "#d7afd7", undercurl = true }, -- SpellRare      xxx cterm=underline ctermfg=182 gui=undercurl guisp=#d7afd7
	SpellLocal = { sp = "#87af87", undercurl = true }, -- SpellLocal     xxx cterm=underline ctermfg=108 gui=undercurl guisp=#87af87
	Pmenu = { bg = "#262626" }, -- Pmenu          xxx ctermbg=235 guibg=#262626
	PmenuKind = { link = "Pmenu" }, -- PmenuKind      xxx links to Pmenu
	PmenuExtra = { link = "Pmenu" }, -- PmenuExtra     xxx links to Pmenu
	NormalFloat = { link = "Pmenu" }, -- NormalFloat    xxx links to Pmenu
	MessageWindow = { link = "Pmenu" }, -- MessageWindow  xxx links to Pmenu
	PmenuSel = { fg = "#1c1c1c", bg = "#afaf87" }, -- PmenuSel       xxx ctermfg=234 ctermbg=144 guifg=#1c1c1c guibg=#afaf87
	PmenuKindSel = { link = "PmenuSel" }, -- PmenuKindSel   xxx links to PmenuSel
	PmenuExtraSel = { link = "PmenuSel" }, -- PmenuExtraSel  xxx links to PmenuSel
	...
	TabLineSel = { bold = true }, -- TabLineSel     xxx cterm=bold gui=bold
	...
	NvimTreeCursorColumn = { link = "CursorColumn" }, -- NvimTreeCursorColumn xxx links to CursorColumn
	CursorLine = { bg = "#303030" }, -- CursorLine     xxx ctermbg=236 guibg=#303030
	LazyButton = { link = "CursorLine" }, -- LazyButton     xxx links to CursorLine
	NvimTreeCursorLine = { link = "CursorLine" }, -- NvimTreeCursorLine xxx links to CursorLine
	...
	WinBar = { bold = true }, -- WinBar         xxx cterm=bold gui=bold
	WinBarNC = { link = "WinBar" }, -- WinBarNC       xxx links to WinBar
	...
	NvimSpacing = { link = "Normal" }, -- NvimSpacing    xxx links to Normal
	NvimTreeNormal = { link = "Normal" }, -- NvimTreeNormal xxx links to Normal
	NvimTreePopup = { link = "Normal" }, -- NvimTreePopup  xxx links to Normal
	Terminal = { link = "Normal" }, -- Terminal       xxx links to Normal
	vimVar = { link = "Normal" }, -- vimVar         xxx links to Normal
	vimOper = { link = "Normal" }, -- vimOper        xxx links to Normal
	vimSep = { link = "Normal" }, -- vimSep         xxx links to Normal
	vimParenSep = { link = "Normal" }, -- vimParenSep    xxx links to Normal
	...
	RedrawDebugNormal = { reverse = true }, -- RedrawDebugNormal xxx cterm=reverse gui=reverse
	...
	Error = { bg = "#1c1c1c", reverse = true, fg = "#d75f5f" }, -- Error          xxx cterm=reverse ctermfg=167 ctermbg=234 gui=reverse guifg=#d75f5f guibg=#1c1c1c
	NvimInvalid = { link = "Error" }, -- NvimInvalid    xxx links to Error
	luaParenError = { link = "Error" }, -- luaParenError  xxx links to Error
	luaError = { link = "Error" }, -- luaError       xxx links to Error
	Todo = { bg = "#1c1c1c", reverse = true, fg = "#d7d787" }, -- Todo           xxx cterm=reverse ctermfg=186 ctermbg=234 gui=reverse guifg=#d7d787 guibg=#1c1c1c
	["@text.todo"] = { link = "Todo" }, -- @text.todo     xxx links to Todo
	luaTodo = { link = "Todo" }, -- luaTodo        xxx links to Todo
	PopupNotification = { link = "Todo" }, -- PopupNotification xxx links to Todo
	String = { fg = "#87af87" }, -- String         xxx ctermfg=108 guifg=#87af87
	["@string"] = { link = "String" }, -- @string        xxx links to String
	NvimString = { link = "String" }, -- NvimString     xxx links to String
	markdownUrl = { link = "String" }, -- markdownUrl    xxx links to String
	TelescopePreviewSize = { link = "String" }, -- TelescopePreviewSize xxx links to String
	TelescopePreviewExecute = { link = "String" }, -- TelescopePreviewExecute xxx links to String
	luaString2 = { link = "String" }, -- luaString2     xxx links to String
	luaString = { link = "String" }, -- luaString      xxx links to String
	elixirDocTest = { link = "String" }, -- elixirDocTest  xxx links to String
	Constant = { fg = "#d7875f" }, -- Constant       xxx ctermfg=173 guifg=#d7875f
	Number = { link = "Constant" }, -- Number         xxx links to Constant
	Boolean = { link = "Constant" }, -- Boolean        xxx links to Constant
	["@constant"] = { link = "Constant" }, -- @constant      xxx links to Constant
	["@lsp.type.enumMember"] = { link = "Constant" }, -- @lsp.type.enumMember xxx links to Constant
	LazyProgressDone = { link = "Constant" }, -- LazyProgressDone xxx links to Constant
	LazyReasonEvent = { link = "Constant" }, -- LazyReasonEvent xxx links to Constant
	TelescopePreviewRead = { link = "Constant" }, -- TelescopePreviewRead xxx links to Constant
	TelescopePreviewBlock = { link = "Constant" }, -- TelescopePreviewBlock xxx links to Constant
	TelescopeResultsConstant = { link = "Constant" }, -- TelescopeResultsConstant xxx links to Constant
	TelescopePreviewPipe = { link = "Constant" }, -- TelescopePreviewPipe xxx links to Constant
	TelescopePreviewUser = { link = "Constant" }, -- TelescopePreviewUser xxx links to Constant
	TelescopePreviewGroup = { link = "Constant" }, -- TelescopePreviewGroup xxx links to Constant
	TelescopePreviewCharDev = { link = "Constant" }, -- TelescopePreviewCharDev xxx links to Constant
	luaConstant = { link = "Constant" }, -- luaConstant    xxx links to Constant
	Character = { fg = "#afd7af" }, -- Character      xxx ctermfg=151 guifg=#afd7af
	["@character"] = { link = "Character" }, -- @character     xxx links to Character
	LazyReasonFt = { link = "Character" }, -- LazyReasonFt   xxx links to Character
	LazyReasonSource = { link = "Character" }, -- LazyReasonSource xxx links to Character
	Identifier = { fg = "#87afaf" }, -- Identifier     xxx ctermfg=109 guifg=#87afaf
	Function = { link = "Identifier" }, -- Function       xxx links to Identifier
	["@text.reference"] = { link = "Identifier" }, -- @text.reference xxx links to Identifier
	["@parameter"] = { link = "Identifier" }, -- @parameter     xxx links to Identifier
	["@field"] = { link = "Identifier" }, -- @field         xxx links to Identifier
	["@property"] = { link = "Identifier" }, -- @property      xxx links to Identifier
	["@variable"] = { link = "Identifier" }, -- @variable      xxx links to Identifier
	["@namespace"] = { link = "Identifier" }, -- @namespace     xxx links to Identifier
	["@lsp.type.parameter"] = { link = "Identifier" }, -- @lsp.type.parameter xxx links to Identifier
	["@lsp.type.property"] = { link = "Identifier" }, -- @lsp.type.property xxx links to Identifier
	["@lsp.type.variable"] = { link = "Identifier" }, -- @lsp.type.variable xxx links to Identifier
	NvimIdentifier = { link = "Identifier" }, -- NvimIdentifier xxx links to Identifier
	LazyReasonImport = { link = "Identifier" }, -- LazyReasonImport xxx links to Identifier
	TelescopeMultiIcon = { link = "Identifier" }, -- TelescopeMultiIcon xxx links to Identifier
	TelescopeResultsIdentifier = { link = "Identifier" }, -- TelescopeResultsIdentifier xxx links to Identifier
	luaFunc = { link = "Identifier" }, -- luaFunc        xxx links to Identifier
	Statement = { fg = "#af87af" }, -- Statement      xxx ctermfg=139 guifg=#af87af
	Conditional = { link = "Statement" }, -- Conditional    xxx links to Statement
	Repeat = { link = "Statement" }, -- Repeat         xxx links to Statement
	Label = { link = "Statement" }, -- Label          xxx links to Statement
	Operator = { link = "Statement" }, -- Operator       xxx links to Statement
	Keyword = { link = "Statement" }, -- Keyword        xxx links to Statement
	Exception = { link = "Statement" }, -- Exception      xxx links to Statement
	LazyReasonKeys = { link = "Statement" }, -- LazyReasonKeys xxx links to Statement
	TelescopePreviewWrite = { link = "Statement" }, -- TelescopePreviewWrite xxx links to Statement
	TelescopePreviewSocket = { link = "Statement" }, -- TelescopePreviewSocket xxx links to Statement
	luaStatement = { link = "Statement" }, -- luaStatement   xxx links to Statement
	javaScriptFunction = { link = "Statement" }, -- javaScriptFunction xxx links to Statement
	javaScriptIdentifier = { link = "Statement" }, -- javaScriptIdentifier xxx links to Statement
	sqlKeyword = { link = "Statement" }, -- sqlKeyword     xxx links to Statement
	yamlBlockMappingKey = { link = "Statement" }, -- yamlBlockMappingKey xxx links to Statement
	rubyMacro = { link = "Statement" }, -- rubyMacro      xxx links to Statement
	rubyDefine = { link = "Statement" }, -- rubyDefine     xxx links to Statement
	elixirOperator = { link = "Statement" }, -- elixirOperator xxx links to Statement
	elixirKeyword = { link = "Statement" }, -- elixirKeyword  xxx links to Statement
	elixirBlockDefinition = { link = "Statement" }, -- elixirBlockDefinition xxx links to Statement
	elixirDefine = { link = "Statement" }, -- elixirDefine   xxx links to Statement
	elixirPrivateDefine = { link = "Statement" }, -- elixirPrivateDefine xxx links to Statement
	elixirGuard = { link = "Statement" }, -- elixirGuard    xxx links to Statement
	elixirPrivateGuard = { link = "Statement" }, -- elixirPrivateGuard xxx links to Statement
	elixirModuleDefine = { link = "Statement" }, -- elixirModuleDefine xxx links to Statement
	elixirProtocolDefine = { link = "Statement" }, -- elixirProtocolDefine xxx links to Statement
	elixirImplDefine = { link = "Statement" }, -- elixirImplDefine xxx links to Statement
	elixirRecordDefine = { link = "Statement" }, -- elixirRecordDefine xxx links to Statement
	elixirPrivateRecordDefine = { link = "Statement" }, -- elixirPrivateRecordDefine xxx links to Statement
	elixirMacroDefine = { link = "Statement" }, -- elixirMacroDefine xxx links to Statement
	elixirPrivateMacroDefine = { link = "Statement" }, -- elixirPrivateMacroDefine xxx links to Statement
	elixirDelegateDefine = { link = "Statement" }, -- elixirDelegateDefine xxx links to Statement
	elixirOverridableDefine = { link = "Statement" }, -- elixirOverridableDefine xxx links to Statement
	elixirExceptionDefine = { link = "Statement" }, -- elixirExceptionDefine xxx links to Statement
	elixirCallbackDefine = { link = "Statement" }, -- elixirCallbackDefine xxx links to Statement
	elixirStructDefine = { link = "Statement" }, -- elixirStructDefine xxx links to Statement
	elixirExUnitMacro = { link = "Statement" }, -- elixirExUnitMacro xxx links to Statement
	elixirInclude = { link = "Statement" }, -- elixirInclude  xxx links to Statement
	PreProc = { fg = "#afaf87" }, -- PreProc        xxx ctermfg=144 guifg=#afaf87
	Include = { link = "PreProc" }, -- Include        xxx links to PreProc
	Define = { link = "PreProc" }, -- Define         xxx links to PreProc
	Macro = { link = "PreProc" }, -- Macro          xxx links to PreProc
	PreCondit = { link = "PreProc" }, -- PreCondit      xxx links to PreProc
	["@preproc"] = { link = "PreProc" }, -- @preproc       xxx links to PreProc
	elixirAtom = { link = "PreProc" }, -- elixirAtom     xxx links to PreProc
	Type = { fg = "#87afd7" }, -- Type           xxx ctermfg=110 guifg=#87afd7
	StorageClass = { link = "Type" }, -- StorageClass   xxx links to Type
	Structure = { link = "Type" }, -- Structure      xxx links to Type
	Typedef = { link = "Type" }, -- Typedef        xxx links to Type
	["@type"] = { link = "Type" }, -- @type          xxx links to Type
	["@lsp.type.type"] = { link = "Type" }, -- @lsp.type.type xxx links to Type
	NvimNumberPrefix = { link = "Type" }, -- NvimNumberPrefix xxx links to Type
	NvimOptionSigil = { link = "Type" }, -- NvimOptionSigil xxx links to Type
	TelescopeMultiSelection = { link = "Type" }, -- TelescopeMultiSelection xxx links to Type
	NullLsInfoTitle = { link = "Type" }, -- NullLsInfoTitle xxx links to Type
	LspInfoFiletype = { link = "Type" }, -- LspInfoFiletype xxx links to Type
	Special = { fg = "#5f8787" }, -- Special        xxx ctermfg=66 guifg=#5f8787
	Tag = { link = "Special" }, -- Tag            xxx links to Special
	SpecialChar = { link = "Special" }, -- SpecialChar    xxx links to Special
	Delimiter = { link = "Special" }, -- Delimiter      xxx links to Special
	SpecialComment = { link = "Special" }, -- SpecialComment xxx links to Special
	["@constructor"] = { link = "Special" }, -- @constructor   xxx links to Special
	LazyReasonPlugin = { link = "Special" }, -- LazyReasonPlugin xxx links to Special
	TelescopePreviewLink = { link = "Special" }, -- TelescopePreviewLink xxx links to Special
	Debug = { fg = "#5f8787" }, -- Debug          xxx ctermfg=66 guifg=#5f8787
	["@debug"] = { link = "Debug" }, -- @debug         xxx links to Debug
	DiagnosticError = { fg = "red" }, -- DiagnosticError xxx ctermfg=1 guifg=Red
	DiagnosticVirtualTextError = { link = "DiagnosticError" }, -- DiagnosticVirtualTextError xxx links to DiagnosticError
	DiagnosticFloatingError = { link = "DiagnosticError" }, -- DiagnosticFloatingError xxx links to DiagnosticError
	DiagnosticSignError = { link = "DiagnosticError" }, -- DiagnosticSignError xxx links to DiagnosticError
	NvimTreeLspDiagnosticsError = { link = "DiagnosticError" }, -- NvimTreeLspDiagnosticsError xxx links to DiagnosticError
	DiagnosticWarn = { fg = "orange" }, -- DiagnosticWarn xxx ctermfg=3 guifg=Orange
	DiagnosticVirtualTextWarn = { link = "DiagnosticWarn" }, -- DiagnosticVirtualTextWarn xxx links to DiagnosticWarn
	DiagnosticFloatingWarn = { link = "DiagnosticWarn" }, -- DiagnosticFloatingWarn xxx links to DiagnosticWarn
	DiagnosticSignWarn = { link = "DiagnosticWarn" }, -- DiagnosticSignWarn xxx links to DiagnosticWarn
	LazyNoCond = { link = "DiagnosticWarn" }, -- LazyNoCond     xxx links to DiagnosticWarn
	NvimTreeLspDiagnosticsWarning = { link = "DiagnosticWarn" }, -- NvimTreeLspDiagnosticsWarning xxx links to DiagnosticWarn
	DiagnosticInfo = { fg = "lightblue" }, -- DiagnosticInfo xxx ctermfg=4 guifg=LightBlue
	DiagnosticVirtualTextInfo = { link = "DiagnosticInfo" }, -- DiagnosticVirtualTextInfo xxx links to DiagnosticInfo
	DiagnosticFloatingInfo = { link = "DiagnosticInfo" }, -- DiagnosticFloatingInfo xxx links to DiagnosticInfo
	DiagnosticSignInfo = { link = "DiagnosticInfo" }, -- DiagnosticSignInfo xxx links to DiagnosticInfo
	NvimTreeLspDiagnosticsInformation = { link = "DiagnosticInfo" }, -- NvimTreeLspDiagnosticsInformation xxx links to DiagnosticInfo
	DiagnosticHint = { fg = "lightgrey" }, -- DiagnosticHint xxx ctermfg=7 guifg=LightGrey
	DiagnosticVirtualTextHint = { link = "DiagnosticHint" }, -- DiagnosticVirtualTextHint xxx links to DiagnosticHint
	DiagnosticFloatingHint = { link = "DiagnosticHint" }, -- DiagnosticFloatingHint xxx links to DiagnosticHint
	DiagnosticSignHint = { link = "DiagnosticHint" }, -- DiagnosticSignHint xxx links to DiagnosticHint
	NvimTreeLspDiagnosticsHint = { link = "DiagnosticHint" }, -- NvimTreeLspDiagnosticsHint xxx links to DiagnosticHint
	DiagnosticOk = { fg = "lightgreen" }, -- DiagnosticOk   xxx ctermfg=10 guifg=LightGreen
	DiagnosticVirtualTextOk = { link = "DiagnosticOk" }, -- DiagnosticVirtualTextOk xxx links to DiagnosticOk
	DiagnosticFloatingOk = { link = "DiagnosticOk" }, -- DiagnosticFloatingOk xxx links to DiagnosticOk
	DiagnosticSignOk = { link = "DiagnosticOk" }, -- DiagnosticSignOk xxx links to DiagnosticOk
	DiagnosticUnderlineError = { sp = "red", underline = true }, -- DiagnosticUnderlineError xxx cterm=underline gui=underline guisp=Red
	DiagnosticUnderlineWarn = { sp = "orange", underline = true }, -- DiagnosticUnderlineWarn xxx cterm=underline gui=underline guisp=Orange
	DiagnosticUnderlineInfo = { sp = "lightblue", underline = true }, -- DiagnosticUnderlineInfo xxx cterm=underline gui=underline guisp=LightBlue
	DiagnosticUnderlineHint = { sp = "lightgrey", underline = true }, -- DiagnosticUnderlineHint xxx cterm=underline gui=underline guisp=LightGrey
	DiagnosticUnderlineOk = { sp = "lightgreen", underline = true }, -- DiagnosticUnderlineOk xxx cterm=underline gui=underline guisp=LightGreen
	Comment = { fg = "#767676" }, -- Comment        xxx ctermfg=243 guifg=#767676
	["@text.literal"] = { link = "Comment" }, -- @text.literal  xxx links to Comment
	["@comment"] = { link = "Comment" }, -- @comment       xxx links to Comment
	NvimTreeGitIgnored = { link = "Comment" }, -- NvimTreeGitIgnored xxx links to Comment
	LazyComment = { link = "Comment" }, -- LazyComment    xxx links to Comment
	TelescopeResultsComment = { link = "Comment" }, -- TelescopeResultsComment xxx links to Comment
	luaComment = { link = "Comment" }, -- luaComment     xxx links to Comment
	LspInfoTip = { link = "Comment" }, -- LspInfoTip     xxx links to Comment
	vimCommentString = { link = "Comment" }, -- vimCommentString xxx links to Comment
	Underlined = { underline = true }, -- Underlined     xxx cterm=underline gui=underline
	MatchParen = { bg = "#1c1c1c", reverse = true, fg = "#5f8787" }, -- MatchParen     xxx cterm=reverse ctermfg=66 ctermbg=234 gui=reverse guifg=#5f8787 guibg=#1c1c1c
	NvimInternalError = { fg = "red", bg = "red" }, -- NvimInternalError xxx ctermfg=9 ctermbg=9 guifg=Red guibg=Red
	NvimFigureBrace = { link = "NvimInternalError" }, -- NvimFigureBrace xxx links to NvimInternalError
	NvimSingleQuotedUnknownEscape = { link = "NvimInternalError" }, -- NvimSingleQuotedUnknownEscape xxx links to NvimInternalError
	NvimInvalidSingleQuotedUnknownEscape = { link = "NvimInternalError" }, -- NvimInvalidSingleQuotedUnknownEscape xxx links to NvimInternalError
	...
	NvimTreeFileDeleted = { link = "NvimTreeGitDeleted" }, -- NvimTreeFileDeleted xxx links to NvimTreeGitDeleted
	NvimTreeGitRenamed = { fg = "#af87af" }, -- NvimTreeGitRenamed xxx guifg=#af87af
	NvimTreeFileRenamed = { link = "NvimTreeGitRenamed" }, -- NvimTreeFileRenamed xxx links to NvimTreeGitRenamed
	NvimTreeGitNew = { fg = "#afaf87" }, -- NvimTreeGitNew xxx guifg=#afaf87
	NvimTreeFileNew = { link = "NvimTreeGitNew" }, -- NvimTreeFileNew xxx links to NvimTreeGitNew
	NvimTreeGitStaged = { fg = "#87af87" }, -- NvimTreeGitStaged xxx guifg=#87af87
	NvimTreeFileStaged = { link = "NvimTreeGitStaged" }, -- NvimTreeFileStaged xxx links to NvimTreeGitStaged
	NvimTreeSpecialFile = { fg = "#afaf87", bold = true, underline = true }, -- NvimTreeSpecialFile xxx gui=bold,underline guifg=#afaf87
	NvimTreeOpenedFile = { fg = "#87af87", bold = true }, -- NvimTreeOpenedFile xxx gui=bold guifg=#87af87
	NvimTreeGitMerge = { fg = "#d7d787" }, -- NvimTreeGitMerge xxx guifg=#d7d787
	NvimTreeFileMerge = { link = "NvimTreeGitMerge" }, -- NvimTreeFileMerge xxx links to NvimTreeGitMerge
	NvimTreeGitDirty = { fg = "#d7875f" }, -- NvimTreeGitDirty xxx guifg=#d7875f
	NvimTreeFileDirty = { link = "NvimTreeGitDirty" }, -- NvimTreeFileDirty xxx links to NvimTreeGitDirty
	NvimTreeImageFile = { fg = "#af87af", bold = true }, -- NvimTreeImageFile xxx gui=bold guifg=#af87af
	NvimTreeFolderIcon = { fg = "#8094b4" }, -- NvimTreeFolderIcon xxx guifg=#8094b4
	NvimTreeOpenedFolderIcon = { link = "NvimTreeFolderIcon" }, -- NvimTreeOpenedFolderIcon xxx links to NvimTreeFolderIcon
	NvimTreeClosedFolderIcon = { link = "NvimTreeFolderIcon" }, -- NvimTreeClosedFolderIcon xxx links to NvimTreeFolderIcon
	diffRemoved = { fg = "#d75f5f" }, -- diffRemoved    xxx ctermfg=167 guifg=#d75f5f
	GitSignsDelete = { link = "diffRemoved" }, -- GitSignsDelete xxx links to diffRemoved
	diffAdded = { fg = "#87af87" }, -- diffAdded      xxx ctermfg=108 guifg=#87af87
	GitSignsAdd = { link = "diffAdded" }, -- GitSignsAdd    xxx links to diffAdded
	NvimTreeWindowPicker = { bg = "#4493c8", bold = true, fg = "#ededed" }, -- NvimTreeWindowPicker xxx gui=bold guifg=#ededed guibg=#4493c8
	...
	lualine_c_filename_normal = { bg = "#191724", bold = true, fg = "#c4a7e7" }, -- lualine_c_filename_normal xxx gui=bold guifg=#c4a7e7 guibg=#191724
	lualine_c_filename_insert = { bg = "#191724", bold = true, fg = "#c4a7e7" }, -- lualine_c_filename_insert xxx gui=bold guifg=#c4a7e7 guibg=#191724
	lualine_c_filename_visual = { bg = "#191724", bold = true, fg = "#c4a7e7" }, -- lualine_c_filename_visual xxx gui=bold guifg=#c4a7e7 guibg=#191724
	lualine_c_filename_replace = { bg = "#191724", bold = true, fg = "#c4a7e7" }, -- lualine_c_filename_replace xxx gui=bold guifg=#c4a7e7 guibg=#191724
	lualine_c_filename_command = { bg = "#191724", bold = true, fg = "#c4a7e7" }, -- lualine_c_filename_command xxx gui=bold guifg=#c4a7e7 guibg=#191724
	lualine_c_filename_terminal = { bg = "#191724", bold = true, fg = "#c4a7e7" }, -- lualine_c_filename_terminal xxx gui=bold guifg=#c4a7e7 guibg=#191724
	lualine_c_filename_inactive = { bg = "#191724", bold = true, fg = "#c4a7e7" }, -- lualine_c_filename_inactive xxx gui=bold guifg=#c4a7e7 guibg=#191724
	lualine_c_branch_normal = { bg = "#191724", bold = true, fg = "#ebbcba" }, -- lualine_c_branch_normal xxx gui=bold guifg=#ebbcba guibg=#191724
	lualine_c_branch_insert = { bg = "#191724", bold = true, fg = "#ebbcba" }, -- lualine_c_branch_insert xxx gui=bold guifg=#ebbcba guibg=#191724
	lualine_c_branch_visual = { bg = "#191724", bold = true, fg = "#ebbcba" }, -- lualine_c_branch_visual xxx gui=bold guifg=#ebbcba guibg=#191724
	lualine_c_branch_replace = { bg = "#191724", bold = true, fg = "#ebbcba" }, -- lualine_c_branch_replace xxx gui=bold guifg=#ebbcba guibg=#191724
	lualine_c_branch_command = { bg = "#191724", bold = true, fg = "#ebbcba" }, -- lualine_c_branch_command xxx gui=bold guifg=#ebbcba guibg=#191724
	lualine_c_branch_terminal = { bg = "#191724", bold = true, fg = "#ebbcba" }, -- lualine_c_branch_terminal xxx gui=bold guifg=#ebbcba guibg=#191724
	lualine_c_branch_inactive = { bg = "#191724", bold = true, fg = "#ebbcba" }, -- lualine_c_branch_inactive xxx gui=bold guifg=#ebbcba guibg=#191724
	...
	lualine_x_7_normal = { bg = "#191724", bold = true, fg = "#9ccfd8" }, -- lualine_x_7_normal xxx gui=bold guifg=#9ccfd8 guibg=#191724
	lualine_x_7_insert = { bg = "#191724", bold = true, fg = "#9ccfd8" }, -- lualine_x_7_insert xxx gui=bold guifg=#9ccfd8 guibg=#191724
	lualine_x_7_visual = { bg = "#191724", bold = true, fg = "#9ccfd8" }, -- lualine_x_7_visual xxx gui=bold guifg=#9ccfd8 guibg=#191724
	lualine_x_7_replace = { bg = "#191724", bold = true, fg = "#9ccfd8" }, -- lualine_x_7_replace xxx gui=bold guifg=#9ccfd8 guibg=#191724
	lualine_x_7_command = { bg = "#191724", bold = true, fg = "#9ccfd8" }, -- lualine_x_7_command xxx gui=bold guifg=#9ccfd8 guibg=#191724
	lualine_x_7_terminal = { bg = "#191724", bold = true, fg = "#9ccfd8" }, -- lualine_x_7_terminal xxx gui=bold guifg=#9ccfd8 guibg=#191724
	lualine_x_7_inactive = { bg = "#191724", bold = true, fg = "#9ccfd8" }, -- lualine_x_7_inactive xxx gui=bold guifg=#9ccfd8 guibg=#191724
	...
	lualine_x_9_normal = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_9_normal xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_9_insert = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_9_insert xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_9_visual = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_9_visual xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_9_replace = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_9_replace xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_9_command = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_9_command xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_9_terminal = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_9_terminal xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_9_inactive = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_9_inactive xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_fileformat_normal = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_fileformat_normal xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_fileformat_insert = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_fileformat_insert xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_fileformat_visual = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_fileformat_visual xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_fileformat_replace = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_fileformat_replace xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_fileformat_command = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_fileformat_command xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_fileformat_terminal = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_fileformat_terminal xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_fileformat_inactive = { bg = "#191724", bold = true, fg = "#31748f" }, -- lualine_x_fileformat_inactive xxx gui=bold guifg=#31748f guibg=#191724
	lualine_x_location_normal = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_location_normal xxx gui=bold guifg=#e0def4 guibg=#191724
	lualine_x_location_insert = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_location_insert xxx gui=bold guifg=#e0def4 guibg=#191724
	lualine_x_location_visual = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_location_visual xxx gui=bold guifg=#e0def4 guibg=#191724
	lualine_x_location_replace = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_location_replace xxx gui=bold guifg=#e0def4 guibg=#191724
	lualine_x_location_command = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_location_command xxx gui=bold guifg=#e0def4 guibg=#191724
	lualine_x_location_terminal = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_location_terminal xxx gui=bold guifg=#e0def4 guibg=#191724
	lualine_x_location_inactive = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_location_inactive xxx gui=bold guifg=#e0def4 guibg=#191724
	lualine_x_progress_normal = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_progress_normal xxx gui=bold guifg=#e0def4 guibg=#191724
	lualine_x_progress_insert = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_progress_insert xxx gui=bold guifg=#e0def4 guibg=#191724
	lualine_x_progress_visual = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_progress_visual xxx gui=bold guifg=#e0def4 guibg=#191724
	lualine_x_progress_replace = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_progress_replace xxx gui=bold guifg=#e0def4 guibg=#191724
	lualine_x_progress_command = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_progress_command xxx gui=bold guifg=#e0def4 guibg=#191724
	lualine_x_progress_terminal = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_progress_terminal xxx gui=bold guifg=#e0def4 guibg=#191724
	lualine_x_progress_inactive = { bg = "#191724", bold = true, fg = "#e0def4" }, -- lualine_x_progress_inactive xxx gui=bold guifg=#e0def4 guibg=#191724
	NvimTreeExecFile = { fg = "#87af87", bold = true }, -- NvimTreeExecFile xxx gui=bold guifg=#87af87
	...
	NvimTreeLiveFilterPrefix = { fg = "#af87af", bold = true }, -- NvimTreeLiveFilterPrefix xxx gui=bold guifg=#af87af
	NvimTreeSym = { fg = "#5f8787", bold = true }, -- NvimTreeSymlink xxx gui=bold guifg] =#5f8787
	NvimTreeBookmark = { fg = "#87af87" }, -- NvimTreeBookmark xxx guifg=#87af87
	NvimTreeLiveFilterValue = { bold = true }, -- NvimTreeLiveFilterValue xxx gui=bold
	...
	ToolbarButton = { bg = "#1c1c1c", bold = true, reverse = true, fg = "#9e9e9e" }, -- ToolbarButton  xxx cterm=bold,reverse ctermfg=247 ctermbg=234 gui=bold,reverse guifg=#9e9e9e guibg=#1c1c1c
...
for group, highlight in pairs(colors) do
