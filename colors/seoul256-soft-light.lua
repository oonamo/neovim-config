...
vim.g.colors_name = "seoul256-soft-light"

-- Highlight groups
local hi = vim.api.nvim_set_hl

hi(0, "ALEErrorSign", { bg = "#ffffff", ctermbg = 231, ctermfg = 161, fg = "#e12672" })
hi(0, "ALEWarningSign", { bg = "#ffffff", ctermbg = 231, ctermfg = 167, fg = "#be7572" })
hi(0, "Boolean", { ctermfg = 175, fg = "#e17899" })
hi(0, "Character", { ctermfg = 175, fg = "#e17899" })
hi(0, "CocFloating", { bg = "#e9e9e9", ctermbg = 255, ctermfg = 241, fg = "#616161" })
hi(0, "ColorColumn", { bg = "#e9e9e9", ctermbg = 255 })
...
hi(0, "Cursor", { bg = "#616161", ctermbg = 241, ctermfg = 231, fg = "#ffffff" })
hi(0, "CursorColumn", { bg = "#f1f1f1", ctermbg = 255 })
hi(0, "CursorLine", { bg = "#f1f1f1", ctermbg = 255 })
hi(0, "CursorLineNr", { bg = "#f1f1f1", bold = true, ctermbg = 255, ctermfg = 167, fg = "#be7572" })
...
hi(0, "Error", { bg = "#e09b99", ctermbg = 174, ctermfg = 231, fg = "#ffffff" })
hi(0, "ErrorMsg", { bg = "#e17899", ctermbg = 175, ctermfg = 231, fg = "#ffffff" })
hi(0, "Exception", { ctermfg = 161, fg = "#e12672" })
hi(0, "ExtraWhitespace", { bg = "#e9e9e9", ctermbg = 255 })
hi(0, "Float", { ctermfg = 244, fg = "#9a7372" })
hi(0, "FoldColumn", { bg = "#e9e9e9", ctermbg = 255, ctermfg = 130, fg = "#9a7200" })
hi(0, "Folded", { bg = "#e9e9e9", ctermbg = 255, ctermfg = 246, fg = "#999872" })
hi(0, "Function", { ctermfg = 94, fg = "#727100" })
hi(0, "GitGutterAdd", { bg = "#e9e9e9", ctermbg = 255, ctermfg = 65, fg = "#719872" })
hi(0, "GitGutterChange", { bg = "#e9e9e9", ctermbg = 255, ctermfg = 104, fg = "#719cdf" })
hi(0, "GitGutterChangeDelete", { bg = "#e9e9e9", ctermbg = 255, ctermfg = 175, fg = "#e17899" })
hi(0, "GitGutterDelete", { bg = "#e9e9e9", ctermbg = 255, ctermfg = 161, fg = "#e12672" })
hi(0, "Identifier", { ctermfg = 139, fg = "#9a7599" })
hi(0, "Ignore", { bg = "#ffffff", ctermbg = 231, ctermfg = 254, fg = "#e1e1e1" })
hi(0, "IncSearch", { bg = "#565656", ctermbg = 240, ctermfg = 220, fg = "#ffdd00" })
hi(0, "Include", { ctermfg = 167, fg = "#be7572" })
hi(0, "IndentGuidesEven", { bg = "#f1f1f1", ctermbg = 255 })
hi(0, "IndentGuidesOdd", { bg = "#ffffff", ctermbg = 231 })
hi(0, "Keyword", { ctermfg = 175, fg = "#e17899" })
hi(0, "LazyBold", { bold = true })
hi(0, "LazyItalic", { italic = true })
hi(0, "LineNr", { bg = "#e9e9e9", ctermbg = 255, ctermfg = 246, fg = "#999872" })
hi(0, "Macro", { ctermfg = 167, fg = "#be7572" })
hi(0, "MatchParen", { bg = "#e1e1e1", bold = true, ctermbg = 254 })
...
hi(0, "Normal", { bg = "#ffffff", ctermbg = 231, ctermfg = 241, fg = "#616161" })
hi(0, "NormalFloat", { bg = "#f1f1f1", ctermbg = 255 })
hi(0, "Number", { ctermfg = 244, fg = "#9a7372" })
hi(0, "Operator", { ctermfg = 167, fg = "#be7572" })
hi(0, "Pmenu", { bg = "#e9e9e9", ctermbg = 255, ctermfg = 241, fg = "#616161" })
...
hi(0, "SignColumn", { bg = "#ffffff", ctermbg = 231, ctermfg = 173, fg = "#e19972" })
hi(0, "SignifySignAdd", { bg = "#e9e9e9", ctermbg = 255, ctermfg = 65, fg = "#719872" })
hi(0, "SignifySignChange", { bg = "#e9e9e9", ctermbg = 255, ctermfg = 104, fg = "#719cdf" })
hi(0, "SignifySignDelete", { bg = "#e9e9e9", ctermbg = 255, ctermfg = 161, fg = "#e12672" })
...
hi(0, "StatusLineNC", { bg = "#565656", ctermbg = 240, ctermfg = 255, fg = "#e9e9e9" })
hi(0, "StatusLineTerm", { bg = "#dfdebd", bold = true, ctermbg = 187, ctermfg = 244, fg = "#9a7372", reverse = true })
hi(0, "StatusLineTermNC", { bg = "#565656", bold = true, ctermbg = 240, ctermfg = 255, fg = "#e9e9e9", reverse = true })
hi(0, "String", { ctermfg = 30, fg = "#009799" })
hi(0, "StringDelimiter", { ctermfg = 130, fg = "#9a7200" })
hi(0, "Structure", { ctermfg = 23, fg = "#007173" })
hi(0, "TabLine", { bg = "#d9d9d9", ctermbg = 253, ctermfg = 244 })
hi(0, "TabLineFill", { ctermfg = 255, fg = "#e9e9e9" })
...
hi(0, "VertSplit", { bg = "#e1e1e1", ctermbg = 254, ctermfg = 254, fg = "#e1e1e1" })
...
hi(0, "ZenBg", { bg = "#ffffff", ctermbg = 231, ctermfg = 231, fg = "#ffffff" })
hi(0, "diffAdded", { ctermfg = 65, fg = "#719872" })
hi(0, "diffLine", { link = "Constant" })
hi(0, "diffRemoved", { ctermfg = 167, fg = "#be7572" })
hi(0, "lCursor", { bg = "#616161", ctermbg = 241, ctermfg = 231, fg = "#ffffff" })
