...
vim.g.colors_name = "seoul256-hard-light"

-- Highlight groups
local hi = vim.api.nvim_set_hl

hi(0, "ALEErrorSign", { bg = "#d9d9d9", ctermbg = 253, ctermfg = 161, fg = "#e12672" })
hi(0, "ALEWarningSign", { bg = "#d9d9d9", ctermbg = 253, ctermfg = 167, fg = "#be7572" })
hi(0, "Boolean", { ctermfg = 175, fg = "#e17899" })
hi(0, "Character", { ctermfg = 175, fg = "#e17899" })
hi(0, "CocFloating", { bg = "#c8c8c8", ctermbg = 251, ctermfg = 241, fg = "#616161" })
hi(0, "ColorColumn", { bg = "#c8c8c8", ctermbg = 251 })
hi(0, "Comment", { ctermfg = 65, fg = "#719872" })
hi(0, "Conceal", { bg = "#e9e9e9", ctermbg = 255, ctermfg = 239, fg = "#4b4b4b" })
hi(0, "Conditional", { ctermfg = 31, fg = "#0099bd" })
hi(0, "Constant", { ctermfg = 23, fg = "#007173" })
hi(0, "Cursor", { bg = "#616161", ctermbg = 241, ctermfg = 253, fg = "#d9d9d9" })
hi(0, "CursorColumn", { bg = "#d1d0d1", ctermbg = 252 })
hi(0, "CursorLine", { bg = "#d1d0d1", ctermbg = 252 })
hi(0, "CursorLineNr", { bg = "#d1d0d1", bold = true, ctermbg = 252, ctermfg = 167, fg = "#be7572" })
...
hi(0, "Error", { bg = "#e09b99", ctermbg = 174, ctermfg = 254, fg = "#e1e1e1" })
hi(0, "ErrorMsg", { bg = "#e17899", ctermbg = 175, ctermfg = 254, fg = "#e1e1e1" })
hi(0, "Exception", { ctermfg = 161, fg = "#e12672" })
hi(0, "ExtraWhitespace", { bg = "#c8c8c8", ctermbg = 251 })
hi(0, "Float", { ctermfg = 244, fg = "#9a7372" })
hi(0, "FoldColumn", { bg = "#c8c8c8", ctermbg = 251, ctermfg = 130, fg = "#9a7200" })
hi(0, "Folded", { bg = "#c8c8c8", ctermbg = 251, ctermfg = 246, fg = "#999872" })
hi(0, "Function", { ctermfg = 94, fg = "#727100" })
hi(0, "GitGutterAdd", { bg = "#c8c8c8", ctermbg = 251, ctermfg = 65, fg = "#719872" })
hi(0, "GitGutterChange", { bg = "#c8c8c8", ctermbg = 251, ctermfg = 104, fg = "#719cdf" })
hi(0, "GitGutterChangeDelete", { bg = "#c8c8c8", ctermbg = 251, ctermfg = 175, fg = "#e17899" })
hi(0, "GitGutterDelete", { bg = "#c8c8c8", ctermbg = 251, ctermfg = 161, fg = "#e12672" })
hi(0, "Identifier", { ctermfg = 139, fg = "#9a7599" })
hi(0, "Ignore", { bg = "#d9d9d9", ctermbg = 253, ctermfg = 250, fg = "#bfbfbf" })
hi(0, "IncSearch", { bg = "#565656", ctermbg = 240, ctermfg = 220, fg = "#ffdd00" })
hi(0, "Include", { ctermfg = 167, fg = "#be7572" })
hi(0, "IndentGuidesEven", { bg = "#d1d0d1", ctermbg = 252 })
hi(0, "IndentGuidesOdd", { bg = "#e1e1e1", ctermbg = 254 })
hi(0, "Keyword", { ctermfg = 175, fg = "#e17899" })
hi(0, "LazyBold", { bold = true })
hi(0, "LazyItalic", { italic = true })
hi(0, "LineNr", { bg = "#c8c8c8", ctermbg = 251, ctermfg = 246, fg = "#999872" })
hi(0, "Macro", { ctermfg = 167, fg = "#be7572" })
hi(0, "MatchParen", { bg = "#bfbfbf", bold = true, ctermbg = 250 })
...
hi(0, "Normal", { bg = "#d9d9d9", ctermbg = 253, ctermfg = 241, fg = "#616161" })
hi(0, "NormalFloat", { bg = "#d1d0d1", ctermbg = 252 })
hi(0, "Number", { ctermfg = 244, fg = "#9a7372" })
hi(0, "Operator", { ctermfg = 167, fg = "#be7572" })
hi(0, "Pmenu", { bg = "#c8c8c8", ctermbg = 251, ctermfg = 241, fg = "#616161" })
...
hi(0, "SignColumn", { bg = "#d9d9d9", ctermbg = 253, ctermfg = 173, fg = "#e19972" })
hi(0, "SignifySignAdd", { bg = "#c8c8c8", ctermbg = 251, ctermfg = 65, fg = "#719872" })
hi(0, "SignifySignChange", { bg = "#c8c8c8", ctermbg = 251, ctermfg = 104, fg = "#719cdf" })
hi(0, "SignifySignDelete", { bg = "#c8c8c8", ctermbg = 251, ctermfg = 161, fg = "#e12672" })
...
hi(0, "ZenBg", { bg = "#d9d9d9", ctermbg = 253, ctermfg = 253, fg = "#d9d9d9" })
hi(0, "diffAdded", { ctermfg = 65, fg = "#719872" })
hi(0, "diffLine", { link = "Constant" })
hi(0, "diffRemoved", { ctermfg = 167, fg = "#be7572" })
hi(0, "lCursor", { bg = "#616161", ctermbg = 241, ctermfg = 253, fg = "#d9d9d9" })
