...
local hlgroups = {
  ...
  SnacksPickerPrompt = { link = "TelescopePrefix" },
  SnacksPickerTitle = { fg = c_subtle, bg = c_faded, bold = true },
  -- SnacksPickerBorder = { fg = c_foreground, bg = c_subtle },
  SnacksPickerBorder = { fg = c_foreground },
  SnacksPickerInputBorder = { fg = c_foreground, bg = c_highlight },
  SnacksPickerPreviewCursorLine = { bg = c_shaded },
  SnacksPickerListCursorLine = { bg = c_shaded },
  SnacksPickerMatch = { fg = c_salient, bold = true },
  SnacksPickerSearch = { link = "IncSearch" },
  -- SnacksPickerMatch = { fg = c_salient, bold = true },
  -- TelescopePromptCounter = { link = 'Comment' },
  SnacksPickerInputTitle = { fg = c_critical },
  SnacksPickerSelected = { fg = c_foreground, bg = c_shaded },
  -- TelescopeMultiIcon = { fg = c_salient, bold = true },
  -- TelescopeMultiSelection = { bg = c_shaded, bold = true },
  -- TelescopeSelectionCaret = { fg = c_critical, bg = c_shaded },
  ...
  -- TelescopePromptNormal = { bg = c_highlight },
  MiniPickHeader = { fg = c_subtle, bg = c_faded, bold = true },
  MiniPickBorder = { fg = c_foreground, bg = c_subtle },
  -- TelescopePromptBorder = { fg = c_foreground, bg = c_highlight },
  MiniPickMatchCurrent = { bg = c_shaded },
  -- TelescopePreviewMatch = { fg = c_salient, bold = true },
  MiniPickMatchRanges = { fg = c_salient, bold = true },
  -- TelescopePromptCounter = { link = 'Comment' },
  -- TelescopePromptPrefix = { fg = c_critical },
  -- TelescopeSelection = { fg = c_foreground, bg = c_shaded },
  -- TelescopeMultiIcon = { fg = c_salient, bold = true },
