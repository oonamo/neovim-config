...
local TextInput = require("onam.form.text-input")
local Select = require("onam.form.select")
local Footer = require("onam.form.footer")

local fn = require("onam.fn")
local validators = require("onam.form.validators")
...
function NuiForm:new(options)
	...
	options.on_submit = vim.F.if_nil(options.on_submit, function() end)
	options.on_close = vim.F.if_nil(options.on_close, function() end)
