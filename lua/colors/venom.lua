...
local mix = function(color1, color2, weight1, weight2)
	...
	local r1, g1, b1 =
		tonumber("0x" .. string.sub(color1, 1, 2)),
		tonumber("0x" .. string.sub(color1, 3, 4)),
		tonumber("0x" .. string.sub(color1, 5, 6))
	local r2, g2, b2 =
		tonumber("0x" .. string.sub(color2, 1, 2)),
		tonumber("0x" .. string.sub(color2, 3, 4)),
		tonumber("0x" .. string.sub(color2, 5, 6))
...
local set_hl = function(group_name, opts)
	...
	if opts.blend ~= nil then
		hl_opts.blend = clamp(opts.blend, 0, 100)
	end
