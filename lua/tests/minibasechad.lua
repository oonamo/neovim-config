...
function M.gencolorscheme(name, theme, base30, override, test)
  ...
  if not test then require("mini.colors").get_colorscheme(nil, { new_name = name }):compress():write() end
end

function M.minioverrides()
  for _, v in ipairs({ "Add", "Change", "Delete" }) do
    local hl = vim.api.nvim_get_hl(0, { name = "MiniDiffSign" .. v })
    if not vim.tbl_isempty(hl) then vim.api.nvim_set_hl(0, "MiniDiffSign" .. v, { fg = hl.fg }) end
  end
  ...
  if effective_name then try_diagnostics(effective_name) end
end
...
function M.getcmp(theme, base30)
  return {
    ...
    BlinkCmpMenu = { link = "CmpPmenu" },
    BlinkCmpMenuBorder = { link = "CmpBorder" },
    BlinkCmpMenuSelection = { link = "PmenuSel" },
    -- BlinkCmpKind = {},
    BlimkCmpKindConstant = { fg = theme.base09 },
    BlimkCmpKindFunction = { fg = theme.base0D },
    BlimkCmpKindIdentifier = { fg = theme.base08 },
    BlimkCmpKindField = { fg = theme.base08 },
    BlimkCmpKindVariable = { fg = theme.base0E },
    BlimkCmpKindSnippet = { fg = base30.red },
    BlimkCmpKindText = { fg = theme.base0B },
    BlimkCmpKindStructure = { fg = theme.base0E },
    BlimkCmpKindType = { fg = theme.base0A },
    BlimkCmpKindKeyword = { fg = theme.base07 },
    BlimkCmpKindMethod = { fg = theme.base0D },
    BlimkCmpKindConstructor = { fg = base30.blue },
    BlimkCmpKindFolder = { fg = theme.base07 },
    BlimkCmpKindModule = { fg = theme.base0A },
    BlimkCmpKindProperty = { fg = theme.base08 },
    BlimkCmpKindEnum = { fg = base30.blue },
    BlimkCmpKindUnit = { fg = theme.base0E },
    BlimkCmpKindClass = { fg = base30.teal },
    BlimkCmpKindFile = { fg = theme.base07 },
    BlimkCmpKindInterface = { fg = base30.green },
    BlimkCmpKindColor = { fg = base30.white },
    BlimkCmpKindReference = { fg = theme.base05 },
    BlimkCmpKindEnumMember = { fg = base30.purple },
    BlimkCmpKindStruct = { fg = theme.base0E },
    BlimkCmpKindValue = { fg = base30.cyan },
    BlimkCmpKindEvent = { fg = base30.yellow },
    BlimkCmpKindOperator = { fg = theme.base05 },
    BlimkCmpKindTypeParameter = { fg = theme.base08 },
    BlimkCmpKindCopilot = { fg = base30.green },
